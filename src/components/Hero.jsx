    ...
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <section className="max-w-4xl w-full flex flex-col md:flex-row items-center justify-between gap-8 py-12">
        ...
        <div className="md:flex-1 space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-600 to-purple-500 bg-clip-text text-transparent">
            Rahul Verma
          </h1>
          ...
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-400 max-w-2xl">
            Self-taught developer passionate about creating beautiful, functional web experiences.
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <button 
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/30"
